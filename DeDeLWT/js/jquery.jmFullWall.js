...
(function ($) {
  ...
  $.fn.jmFullWall = function (options) {
    ...
    var wall_top_height = 0; // parseInt($(wall_top).css('height'));
    ...
    wallDimension = function (resize) {
      ...
      wall_container_w = parseInt($(".grid").width());
    ...
    itemActions = function () {
      ...
      a.bind('click', function () {
        ...
        $.imgpreload($img_detail, function () {
          ...
          ht += '<a href="javascript:;" rel="' + prev_item + '" class="' + options.itemsBtnClose + '"><\/a>';
          ht += '<a href="javascript:;" rel="' + prev_item + '" class="' + options.itemsBtnPrev + '"><\/a>';
          ht += '<a href="javascript:;" rel="' + next_item + '" class="' + options.itemsBtnNext + '"><\/a>';
    ...
    setBgImage = function (img, w, h) {
      ...
      if (img_w > wall_container_w) {
        img_h = img_h * wall_container_w / img_w;
        img_w = wall_container_w;
      }
      if (img_h > wall_container_h) {
        img_w = img_w * wall_container_h / img_h;
        img_h = wall_container_h;
      }
      image = '<img src="' + img_src + '" width="' + img_w + '" height="' + img_h + '" class="imgZoom" />';
